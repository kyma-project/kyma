...
DOCKER_CREATE_OPTS := -v $(shell go env GOCACHE):$(IMG_GOCACHE):delegated -v $(shell go env GOPATH)/pkg/mod:$(IMG_GOPATH)/pkg/mod:delegated $(DOCKER_CREATE_OPTS)
endif
...
#   verify:: errcheck
#
verify:: test check-imports check-fmt mod-verify
format:: imports fmt
...
MOUNT_TARGETS = build resolve mod-verify check-imports imports check-fmt fmt errcheck vet generate pull-licenses gqlgen

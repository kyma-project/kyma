...
DOCKER_CREATE_OPTS := -v $(shell go env GOCACHE):$(IMG_GOCACHE):delegated $(DOCKER_CREATE_OPTS)
endif
...
release: mod-verify verify build-image push-image
...
MOUNT_TARGETS = build resolve check-imports mod-verify imports check-fmt fmt errcheck vet generate pull-licenses gqlgen
$(foreach t,$(MOUNT_TARGETS),$(eval $(call buildpack-mount,$(t))))

build-local:
	env GO111MODULE=on CGO_ENABLED=0 go build -o $(APP_NAME) ./$(ENTRYPOINT)

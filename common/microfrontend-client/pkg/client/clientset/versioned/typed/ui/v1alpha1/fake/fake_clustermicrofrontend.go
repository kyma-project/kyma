...
func (c *FakeClusterMicroFrontends) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ClusterMicroFrontend, err error) {
	obj, err := c.Fake.
...
func (c *FakeClusterMicroFrontends) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ClusterMicroFrontendList, err error) {
	obj, err := c.Fake.
...
func (c *FakeClusterMicroFrontends) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *FakeClusterMicroFrontends) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
...
func (c *FakeClusterMicroFrontends) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewRootDeleteCollectionAction(clustermicrofrontendsResource, listOpts)

...
type ClusterMicroFrontendInterface interface {
	Create(ctx context.Context, clusterMicroFrontend *v1alpha1.ClusterMicroFrontend, opts v1.CreateOptions) (*v1alpha1.ClusterMicroFrontend, error)
	Update(ctx context.Context, clusterMicroFrontend *v1alpha1.ClusterMicroFrontend, opts v1.UpdateOptions) (*v1alpha1.ClusterMicroFrontend, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*v1alpha1.ClusterMicroFrontend, error)
	List(ctx context.Context, opts v1.ListOptions) (*v1alpha1.ClusterMicroFrontendList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ClusterMicroFrontend, err error)
...
func (c *clusterMicroFrontends) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ClusterMicroFrontend, err error) {
...
func (c *clusterMicroFrontends) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ClusterMicroFrontendList, err error) {
...
func (c *clusterMicroFrontends) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *clusterMicroFrontends) Create(ctx context.Context, clusterMicroFrontend *v1alpha1.ClusterMicroFrontend, opts v1.CreateOptions) (result *v1alpha1.ClusterMicroFrontend, err error) {
	result = &v1alpha1.ClusterMicroFrontend{}
	err = c.client.Post().
		Resource("clustermicrofrontends").
		VersionedParams(&opts, scheme.ParameterCodec).
...
func (c *clusterMicroFrontends) Update(ctx context.Context, clusterMicroFrontend *v1alpha1.ClusterMicroFrontend, opts v1.UpdateOptions) (result *v1alpha1.ClusterMicroFrontend, err error) {
	result = &v1alpha1.ClusterMicroFrontend{}
	err = c.client.Put().
		Resource("clustermicrofrontends").
...
func (c *clusterMicroFrontends) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *clusterMicroFrontends) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *clusterMicroFrontends) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ClusterMicroFrontend, err error) {
	result = &v1alpha1.ClusterMicroFrontend{}

...
function start() {
    ...
    --extra-config=apiserver.Admission.PluginNames="LimitRanger,ServiceAccount,DefaultStorageClass,MutatingAdmissionWebhook,MutatingAdmissionWebhook,ResourceQuota,PodPreset" \

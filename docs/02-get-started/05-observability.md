...
You can now browse the logs.  
   ...
   > **NOTE:** You can find different ways of displaying logs (for example, in Kyma Dashboard or using `kubectl`) on the [Access Kyma application logs](./04-operation-guides/operations/obsv-01-access-logs) page.

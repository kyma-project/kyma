...
> **NOTE:** See how to [expose Grafana securely](../04-operation-guides/security/sec-06-access-expose-kiali-grafana.md#kubernetes-logs-in-kyma-dashboard) for easier access in the future.

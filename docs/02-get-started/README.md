...
- [k3d](https://k3d.io) (v4.0.0 or higher with [Kubernetes](https://kubernetes.io/docs/setup/) v1.19 - for higher versions, see [this tutorial](../../04-operation-guides/operations/02-install-kyma.md)

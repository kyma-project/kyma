...
The Kyma project is currently in the transition phase from classic to modular Kyma. You can either install classic Kyma with its components, or available modules. To see the list of Kyma modules, go to [Overview](../01-overview/README.md). To learn how to enable a Kyma module go to [Enable, disable and upgrade a Kyma module](../04-operation-guides/operations/08-enable-disable-upgrade-kyma-module.md).

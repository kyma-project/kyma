...
>**NOTE:** If you don't own a domain which you can use, or you don't want to assign a domain to a cluster, see the **Install Kyma on a GKE cluster with wildcard DNS** which shows you how to create a cluster-based playground environment using a wildcard DNS provided by xip.io. 

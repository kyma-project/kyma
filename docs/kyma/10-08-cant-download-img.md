...
``` bash
ERROR: Failed to pull image "eu.gcr.io/kyma-project/incubator/pr/k8s-tools:20210203-PR-61": rpc error: code = Unknown desc = Error response from daemon: Get https://eu.gcr.io/v2/: dial tcp: lookup eu.gcr.io on 192.168.64.1:53: read udp 192.168.64.5:55778->192.168.64.1:53: read: connection refused
```

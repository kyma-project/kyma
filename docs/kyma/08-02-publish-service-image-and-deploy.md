...
1. Download the `http-db-service` example from the [`examples`](https://github.com/kyma-project/examples) repository. Navigate to the `examples/http-db-service` directory in your terminal.

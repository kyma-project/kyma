...
>**NOTE:** Kyma does not support a dedicated downgrade procedure. You can achieve a similar result by taking a backup from your cluster before upgrade. Read [this](/components/backup/#tutorials-taking-backup-using-velero) document to learn more about backups.

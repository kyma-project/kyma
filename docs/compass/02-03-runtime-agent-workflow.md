...
4. Runtime Agent labels the Runtime data in Director with Event Gateway URL for sending events to the Runtime and Console URL of the Kyma cluster. These URLs are displayed in the Compass UI. 

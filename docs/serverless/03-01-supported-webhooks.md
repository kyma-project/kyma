...
2. **Validation webhook** checks if:
   ...
   - The Function CR contains any envs reserved for the Deployment: `FUNC_RUNTIME`, `FUNC_HANDLER`, `FUNC_TIMEOUT`, `FUNC_PORT`, `PORT`, `MOD_NAME`, `NODE_PATH`, `REQ_MB_LIMIT`, `FUNC_MEMORY_LIMIT`.

...
Depending on a runtime you use to build your Function (Node.js 12, Node.js 14, Python 3.8 and Python 3.9), your Git repository must contain at least a directory with these files:

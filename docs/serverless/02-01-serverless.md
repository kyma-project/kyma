...
2. Before the Function can be saved or updated, it is first updated and then verified by the [defaulting and validation webhooks](#details-supported-webhooks) respectively.

...
| **spec.runtime**                         |       No       | Specifies the runtime of the Function. The available values are `nodejs12`, `python38` and `nodejs14`. It is set to `nodejs12` unless specified otherwise.  |

...
| **spec.env**                             |       No       | Specifies environment variables you need to export for the Function. See [ConfigMap](https://kubernetes.io/docs/serverless/05-01-serverless-envs.md) for more detail. |

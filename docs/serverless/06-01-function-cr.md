...
| **spec.runtime**                         |       No       | Specifies the runtime of the Function. The available values are `nodejs12`, `python38`, `python39` and `nodejs14`. It is set to `nodejs14` unless specified otherwise.  |

...
> **CAUTION:** If you have your own secret in namespace and you don't want that system override this secret. You have to add label `serverless.kyma-project.io/managed: user`

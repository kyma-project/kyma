...
| CustomResourceDefinition (CRD) | A file used to define a Custom Resource. | [CustomResourceDefinitions provided by Kyma](./05-technical-reference/06-custom-resources)      |

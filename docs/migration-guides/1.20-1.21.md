...
```bash
kubectl delete -f eventing.knative.dev/v1alpha1
kubectl delete -f flows.knative.dev/v1alpha1
kubectl delete -f knativekafka.kyma-project.io/v1alpha1
kubectl delete -f messaging.knative.dev/v1alpha1
kubectl delete -f sources.eventing.knative.dev/v1alpha1
kubectl delete -f sources.knative.dev/v1alpha1
```
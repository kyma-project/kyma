...
Ensure Istio sidecars for all Pods are in the proper version after the upgrade. See the [troubleshooting guide](https://kyma-project.io/docs/1.17/components/service-mesh#troubleshooting-incompatible-istio-sidecar-version-after-kyma-upgrade) for more information.

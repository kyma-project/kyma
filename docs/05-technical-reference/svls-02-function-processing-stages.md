...
>**NOTE:** Before you start reading, see the [Function CR](./00-custom-resources/svls-01-function.md) document for the custom resource detailed definition, the list of all Function's condition types, and reasons for their success or failure.

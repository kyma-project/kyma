...
ORY chart consists of Hydra, Oathkeeper, Postgresql and GCloudSQLProxy. The subcharts can be configured.

https://github.com/kyma-project/kyma/blob/main/resources/ory/values.yaml

Zrobic dupną tabelkę z wszystkimi paramami. Wywalić wszystko inne

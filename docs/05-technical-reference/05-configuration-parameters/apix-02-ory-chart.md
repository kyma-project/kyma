...
The ORY chart consists of Hydra, Oathkeeper, Postgresql and GCloudSQLProxy subcharts. To configure the ORY chart, override the default values of its [`values.yaml`](https://github.com/kyma-project/kyma/blob/main/resources/ory/values.yaml) file. This document describes parameters of the main chart that you can configure. The subcharts can be configured.
...
> **TIP:** Odnośmnik do doków hydra, oathkeeper, postresqp i gcloud proxy
http://k8s.ory.sh/helm/oathkeeper.html
https://github.com/ory/k8s/tree/master/helm/charts

...
| **sink** | string **required** | The service that should be used as a target for the events that match the subscription. |
| **source** | string **required** | Source defines the origin of the event. |
...
| **types** | []string | A list of event names. These names will be used for subscribing on the backend. |
...
| **backend.emsTypes** | array | EmsTypes is a list of mappings between event type and EventMesh compatible types. Only used with EventMesh as backend |
| **backend.emsTypes.eventMeshType** | string **required** | EventMeshType is the event type that is used on the event mesh backend |
| **backend.emsTypes.originalType** | string **required** | OriginalType is the event type originally used to subscribe |
...
| **backend.types** | array | Types is a list of event type to consumer name mappings for the Nats backend |
| **backend.types.consumerName** | string | ConsumerName is the name of the Jetstream consumer |
| **backend.types.originalType** | string **required** | OriginalType is the event type originally used to subscribe |
| **conditions** | array | Current state of the Subscription |
| **conditions.lastTransitionTime** | string |  |
| **conditions.message** | string |  |
| **conditions.reason** | string |  |
| **conditions.status** | string **required** | Status of the condition, one of True, False, Unknown |
| **conditions.type** | string |  |
| **ready** | boolean **required** | Overall readiness of the Subscription |
| **types** | array **required** | Types defines the filter's event types after cleanup for use with the configured backend. |
| **types.cleanType** | string **required** | CleanType is the event type after it was cleaned up from backend compatible characters |
| **types.originalType** | string **required** | OriginalType is the event type specified in the subscription spec |

...
| **output.otlp.authentication.basic.password** | object **required** | Contains the basic auth password or a Secret reference. |
...
| **output.otlp.authentication.basic.user** | object **required** | Contains the basic auth username or a Secret reference. |
...
| **output.otlp.endpoint** | object **required** | Defines the host and port (<host>:<port>) of an OTLP endpoint. |
...
| **output.otlp.headers.name** | string **required** | Defines the header name. |

...
| ------------------| ---- | --------------------------------------------- |
| **** | object | Defines the desired state of TracePipeline |
...
| **output.otlp.authentication.basic.password** | object | Contains the basic auth password or a Secret reference. |
...
| **output.otlp.authentication.basic.user** | object | Contains the basic auth username or a Secret reference. |
...
| **output.otlp.endpoint** | object | Defines the host and port (<host>:<port>) of an OTLP endpoint. |
...
| **output.otlp.headers** | Defines custom headers to be added to outgoing HTTP or GRPC requests. | headers |
| **output.otlp.headers.name** | string | Defines the header name. |
...
| Parameter         | Type | Description                                   |
| ------------------| ---- | --------------------------------------------- |
| **** | object | Shows the observed state of the TracePipeline |

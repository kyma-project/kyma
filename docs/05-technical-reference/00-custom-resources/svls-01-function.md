...
| **spec.runtime**                         |       No       | Specifies the runtime of the Function. The available values are `nodejs12`, `nodejs14`, `python39`, and deprecated `python38`. It is set to `nodejs14` unless specified otherwise.  |

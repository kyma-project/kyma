...
4. The agent enriches log data with labels and sends them to the Loki server. For faster data processing, log data is organized in log chunks. A log chunk consists of metadata, such as labels, collected over a certain time period.

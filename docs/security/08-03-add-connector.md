...
To bind Github groups to the default Kyma roles, edit the **bindings** section in [this](https://github.com/kyma-project/kyma/blob/master/resources/cluster-users/values.yaml) file. Follow this template:

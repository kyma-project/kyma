...
Add external, OpenID Connect compliant authentication providers to Kyma using [Dex connectors](https://github.com/dexidp/dex#connectors). Follow this tutorial to add a GitHub connector and use it to authenticate users in Kyma.

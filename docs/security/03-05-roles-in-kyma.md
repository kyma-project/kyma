...
>**CAUTION:** To give a user **kyma-developer** role permissions in a Namespace, you must create a RoleBinding for this user and the **kyma-developer** role and a ClusterRoleBinding for the user and the **kyma-essentials** role. 

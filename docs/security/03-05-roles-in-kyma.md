...
| **kyma-developer** | None | The role created for developers who build implementations using Kyma. It allows you to list and edit Kubernetes and Kyma-specific resources. You need to manually bind it to a user or a group (default `runtimeDeveloper`) in the Namespaces of your choice. |

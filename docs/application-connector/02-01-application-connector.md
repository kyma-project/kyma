...
The AB implements the [Open Service Broker API](https://www.openservicebrokerapi.org/). For more details, see the [Service Brokers](/components/service-catalog#service-brokers-service-brokers) documentation.

...
>**CAUTION:** Documentation in this directory is under development, so some information may not be up-to-date.
...
- Delivers events from the connected external solution to Kyma Eventing.
...
>**TIP:** Follow the [tutorial](/components/rafter/#details-asyncapi-service) to read about the AsyncAPI Service used in Kyma to process AsyncAPI specifications.

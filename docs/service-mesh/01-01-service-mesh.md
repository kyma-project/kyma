...
By default, the Kyma implementation of Istio has mutual TLS (mTLS) enabled. Read [this](https://istio.io/docs/tasks/security/mutual-tls/) document for more information about mTLS in Istio.  

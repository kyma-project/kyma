...
To allow such implementation, you must install Kyma without Istio. Read [this](/docs/root/kyma#installation-custom-component-installation) document for more details.

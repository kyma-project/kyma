...
See this [Istio diagram](https://istio.io/docs/concepts/what-is-istio/img/overview/arch.svg) to understand the relationship between the Istio components and Services.

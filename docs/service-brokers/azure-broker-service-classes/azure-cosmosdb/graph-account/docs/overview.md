...
|--------------|-------------|
| `azure-cosmosdb-graph-account` | Provisions a new CosmosDB database account that can be accessed through any of the Graph (Gremlin) API. The new database account is named using a new UUID. |

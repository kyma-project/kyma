...
| **cluster.disabledNavigationNodes** | An array of categories or specific nodes that you want to hide in the Console UI navigation. To hide a category, make sure the array includes **categoryLabel** for cluster-wide views. For the namespace-related views, add the **namespace** prefix to the label: **namespace.categoryLabel**. To hide a specific node, make sure the array includes **categoryLabel.nodeLabel** or **namespace.categoryLabel.nodeLabel**. For all labels, use lowercase and don't use any spaces or dashes. | [] |
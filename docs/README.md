...
You can enable modules at any time. Give them a try! If you decide that some of them are not needed for your use case, you can disable them and free the resources. Learn how to [enable, disable, and upgrade a module](./02-get-started/08-enable-disable-upgrade-kyma-module.md).
...
| Module | Purpose |
|---|---|
| [BTP Operator](https://kyma-project.github.io/kyma/#/btp-manager/user/README.md) | Within the BTP Operator module, BTP Manager installs SAP BTP Service Operator that allows you to consume SAP BTP services from your Kubernetes cluster using Kubernetes-native tools. |

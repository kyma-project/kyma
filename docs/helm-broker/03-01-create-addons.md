...
See [this](https://github.com/kyma-project/addons/tree/release-0.6/addons/testing-0.0.1/docs) example of the `docs` directory with documentation for the testing addon.

...
> **NOTE:** Only users with the **kyma-admin** role can modify the ClusterAddonsConfiguration CR. To learn more about roles in Kyma, read [this](/components/security/#details-roles-in-kyma) document.

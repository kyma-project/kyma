...
>**NOTE:** If you want to debug the Function using an external IDE (Visual Studio Code or GoLand), follow the [Debug a Function](./svls-05-debug-function.md) tutorial.

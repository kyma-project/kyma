...
Check out this [example](https://github.com/kyma-project/examples/tree/main/scale-to-zero-with-keda) showing how to use kyma serverless and eventing with combination with Keda to acomplish scaling to zero. 

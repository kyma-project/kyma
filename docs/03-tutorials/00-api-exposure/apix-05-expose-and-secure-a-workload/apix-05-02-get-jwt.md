...
This tutorial shows how to get a JSON Web Token (JWT), which can be used to access secured endpoints created in the [Expose and secure a workload with Istio](./apix-07-05-expose-and-secure-workload-istio.md) and [Expose and secure a workload with JWT](./apix-05-03-expose-and-secure-workload-jwt.md) tutorials.

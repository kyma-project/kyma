...
Before you start, Set up [mTLS Gateway](../00-security/02-setup-mtls-gateway.md) to allow mutual authentication in Kyma and make sure that you exported the [bundle certificates](../00-security/02-setup-mtls-gateway#steps).

You can also take a look on tutorial [How to create own self-signed Client Root CA and Certificate](../00-security/02-mtls-selfsign-client-certicate.md)

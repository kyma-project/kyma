...
6.  In the pop-up box, provide the Function's name or leave the autogenerated one, select runtime `Node.js 12`, and press **Create** to confirm changes.
...
7.  In the Function details view that opens up automatically, you will see sample Function's code under the **Code** tab:

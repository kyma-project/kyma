...
- You are using an access token with proper scopes and it is active:
  ...
  4. Generate a [new access token](../../03-tutorials/00-api-exposure/apix-03-expose-and-secure-service-oauth2.md#register-an-oauth2-client-and-get-tokens) if needed.

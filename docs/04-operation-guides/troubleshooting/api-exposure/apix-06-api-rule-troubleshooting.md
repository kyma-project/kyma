...
Read [this technical reference](https://kyma-project.io/docs/kyma/latest/05-technical-reference/apix-03-blacklisted-services/) to learn more about the block list of services in API Gateway.

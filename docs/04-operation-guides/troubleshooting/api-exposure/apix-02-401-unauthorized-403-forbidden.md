...
- You are using an access token with proper scopes and it is active:
  ...
  4. Generate a [new access token](../../../03-tutorials/00-api-exposure/apix-07-expose-and-secure-a-workload/apix-07-01-expose-and-secure-workload-oauth2.md#register-an-oauth2-client-and-get-tokens) if needed.

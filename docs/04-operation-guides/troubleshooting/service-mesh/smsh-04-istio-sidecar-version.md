...
By default, Kyma has sidecar injection disabled - a sidecar is not injected to any Pod in a cluster. For more information, read the document about [disabling Istio sidecar proxy injection](../../operations/smsh-01-istio-enable-sidecar-injection.md).

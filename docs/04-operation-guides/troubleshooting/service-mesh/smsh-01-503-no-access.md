...
6. To regenerate a corrupted certificate, follow [this tutorial](../../../03-tutorials/00-security/01-tls-certificates-security.md). If you are running Kyma provisioned through Gardener, follow [this troubleshooting guide](../security/sec-01-certificates-gardener.md) instead.

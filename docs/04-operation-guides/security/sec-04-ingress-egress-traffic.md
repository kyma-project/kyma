...
Kyma employs the Bring Your Own Domain/Certificates model that requires you to supply the domain, certificate, and key during installation. Read the tutorial to learn how to [set up or update your custom TLS certificate in Kyma](../../03-tutorials/00-security/sec-01-tls-certificates-security.md).

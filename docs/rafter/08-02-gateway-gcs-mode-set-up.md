...
By default, you install Kyma with Rafter in MinIO standalone mode. This tutorial shows how to set MinIO to the Google Cloud Storage (GCS) Gateway mode using an [override](/root/kyma/#configuration-helm-overrides-for-kyma-installation).

...
You can enable modules at any time. Give them a try! If you decide that some of them are not needed for your use case, you can disable them and free the resources. Read [this tutorial](https://kyma-project.io/docs/kyma/main/04-operation-guides/operations/08-install-uninstall-upgrade-kyma-module/) for instructions on how to enable, disable, and upgrade a module.

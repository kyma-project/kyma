...
- With the [Jaeger](https://github.com/jaegertracing) distributed tracing system, you can analyze the path of a request chain going through your distributed applications. This information helps you for example to troubleshoot your applications more easy or optimize the latency and performance of your solution.

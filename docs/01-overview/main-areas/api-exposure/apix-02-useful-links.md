...
- Perform some simple and more advanced tasks:
  ...
  - [Expose a workload with mutual authentication](../../../03-tutorials/00-api-exposure/apix-02-expose-workload-mutual-authentication.md)
  - [Expose multiple workloads on the same host](../../../03-tutorials/00-api-exposure/apix-03-expose-multiple-workloads.md)
  - [Expose and secure a workload with OAuth2](../../../03-tutorials/00-api-exposure/apix-04-expose-and-secure-workload-oauth2.md)

...
- [JetStream](https://docs.nats.io/nats-concepts/jetstream) - provides details on the new functionalities and higher qualities of service on top of NATS. More information can be found [here](../../../05-technical-reference/00-architecture/evnt-01-architecture.md#jet-stream).

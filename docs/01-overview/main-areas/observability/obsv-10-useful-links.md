...
- Understand the architecture of Kyma's [monitoring](../../../05-technical-reference/00-architecture/obsv-01-architecture-monitoring.md), [logging](../../../01-overview/main-areas/telemetry/telemetry-02-logs.md), and [tracing](../../../01-overview/main-areas/telemetry/telemetry-03-traces.md) components.

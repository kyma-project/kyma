...
- Exposed to an external endpoint (HTTPS). With an [APIRule CR](../../../05-technical-reference/00-custom-resources/apig-01-apirule.md), you can define who can reach the endpoint and what operations they can perform on it.

...
Functions support multiple languages by using the underlying execution environments known as runtimes. Currently, you can create Node.js (14) and Python (3.9) Functions in Kyma.

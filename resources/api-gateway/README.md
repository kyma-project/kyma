...
## Overview
API-Gateway is a component that allows exposing services through Kyma Dashboard. It deploys and manages Istio and Ory/Oathkeeper CustomResourceDefinitions (CRDs).

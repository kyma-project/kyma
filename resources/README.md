...
For details on observing metrics, creating dashboards, and setting alerting rules, see [these](https://kyma-project.io/#/03-tutorials/00-observability) tutorials.

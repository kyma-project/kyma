...
prepareSystemNs "kyma-integration" -> envy?

#kubectl label namespace kyma-system "istio-injection=enabled"
kubectl label namespace kyma-integration "istio-injection=enabled" -> envy?

kubectl apply -f /kyma/resources/cluster-prerequisites/remote-environments-minio-secret.yaml -n "kyma-integration"  -> envy?

#kubectl apply -f /kyma/resources/cluster-prerequisites/resource-quotas.yaml -> essentials

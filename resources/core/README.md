...
2. Start a container during the [installation](../../docs/kyma/docs/030-inst-local-from-release.md), and mount the `secrets.yaml` file in the `run.sh` script with the following command:

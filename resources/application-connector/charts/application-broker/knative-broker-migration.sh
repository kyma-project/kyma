...
# this migration script ensures that Knative brokers metrics are still scrapable
# Application-broker creates a Istio PeerAuthentication for newly provisioned ServiceInstances
# for existing ones, the following migartion has to be performed:
# migrate over all Knative brokers and

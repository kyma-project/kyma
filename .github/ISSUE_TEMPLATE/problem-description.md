...
about: Capture a concise, evidence-based problem
---
...
<!-- Provide a concise, outcome-oriented summary that clearly states the core problem. 
This section is about truly understanding the problem, not jumping to solutions. Use the "Who, What, When, Where, Why" framework to dig into the root cause. -->

### What is the current state, unmet need, or symptom?
<!-- Describe the situation users are facing today.-->

### Who is affected?
<!-- List specific personas, roles, or customer segments impacted. -->
...
<!-- Teams/systems we depend on:
Decision owners and approvers (if any):
Customer access/recruiting needs:-->

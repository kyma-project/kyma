...
[![Build status](https://status.build.kyma-project.io/badge.svg?jobs=pre-master-kyma-integration)](https://status.build.kyma-project.io/?job=pre-master-kyma-integration)

...
projects = [
    ...
    "components/application-registry": "application-registry",
    ...
    "components/application-proxy": "application-proxy",
    "components/k8s-dashboard-proxy": "k8s-dashboard-proxy",
    "components/xip-patch": "xip-patch",
    ...
    "tests/test-namespace-controller": "test-namespace-controller",
    ...
    "tests/application-registry-tests": "application-registry-tests",

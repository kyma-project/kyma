...
import (
	...
	v1alpha1 "github.com/kyma-project/kyma/components/event-bus/generated/ea/listers/remoteenvironment.kyma.cx/v1alpha1"
	remoteenvironment_kyma_io_v1alpha1 "github.com/kyma-project/kyma/components/event-bus/internal/ea/apis/remoteenvironment.kyma.cx/v1alpha1"
...
func NewFilteredEventActivationInformer(client versioned.Interface, namespace string, resyncPeriod time.Duration, indexers cache.Indexers, tweakListOptions internalinterfaces.TweakListOptionsFunc) cache.SharedIndexInformer {
	return cache.NewSharedIndexInformer(
		...
		&remoteenvironment_kyma_io_v1alpha1.EventActivation{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *eventActivationInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&remoteenvironment_kyma_io_v1alpha1.EventActivation{}, f.defaultInformer)
}

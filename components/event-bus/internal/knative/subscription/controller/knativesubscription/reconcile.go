...
func (r *reconciler) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	log.Info("Reconciling Knative Subscription", "UID", string(sub.ObjectMeta.UID))
...
func (r *reconciler) reconcile(ctx context.Context, sub *evapisv1alpha1.Subscription) (bool, error) {
	...
	log.Info("Kyma subscription found: ", "sub", kymaSub)
	...
	for _, cond := range kymaSub.Status.Conditions {
		if cond.Type == subApis.SubscriptionReady {

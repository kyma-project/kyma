...
func (_m *clusterAddonsCfgMutations) Create(name string, urls []string, labels *gqlschema.Labels) (*v1alpha1.ClusterAddonsConfiguration, error) {
...
func (_m *clusterAddonsCfgMutations) Update(name string, urls []string, labels *gqlschema.Labels) (*v1alpha1.ClusterAddonsConfiguration, error) {
	ret := _m.Called(name, urls, labels)

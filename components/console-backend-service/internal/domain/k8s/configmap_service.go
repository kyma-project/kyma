...
func (svc *configMapService) Update(name, namespace string, update v1.ConfigMap) (*v1.ConfigMap, error) {
	...
	updated, err := svc.client.ConfigMaps(namespace).Update(context.TODO(), &update, metav1.UpdateOptions{})
	if err != nil {
		return nil, err
	}
...
func (svc *configMapService) Delete(name, namespace string) error {
	return svc.client.ConfigMaps(namespace).Delete(context.TODO(), name, metav1.DeleteOptions{})
}

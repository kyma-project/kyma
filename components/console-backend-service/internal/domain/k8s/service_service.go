...
func (svc *serviceService) Update(name, namespace string, update v1.Service) (*v1.Service, error) {
	...
	updated, err := svc.client.Services(namespace).Update(context.TODO(), &update, metav1.UpdateOptions{})
	if err != nil {
		return nil, err
	}
...
func (svc *serviceService) Delete(name, namespace string) error {
	return svc.client.Services(namespace).Delete(context.TODO(), name, metav1.DeleteOptions{})
}

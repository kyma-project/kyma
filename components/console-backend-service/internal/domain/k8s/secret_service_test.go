...
// 	t.Run("Success", func(t *testing.T) {
// 		exampleName := "exampleSecret"
// 		exampleNamespace := "exampleNamespace"
// 		exampleSecret := fixSecret(exampleName, exampleNamespace, nil)
// 		secretInformer, client := fixSecretInformer(exampleSecret)
// 		svc := k8s.NewSecretService(secretInformer, client)
//
// 		update := exampleSecret.DeepCopy()
// 		update.Labels = map[string]string{
// 			"example": "example",
// 		}
//
// 		secret, err := svc.Update(exampleName, exampleNamespace, *update)
// 		require.NoError(t, err)
// 		assert.Equal(t, update, secret)
//
// 		secret, err = client.Secrets(exampleNamespace).Get(exampleName, metav1.GetOptions{})
// 		require.NoError(t, err)
// 		assert.Equal(t, update, secret)
// 	})
//
...
// 		exampleNamespace := "exampleNamespace"
// 		exampleSecret := fixSecret(exampleName, exampleNamespace, nil)
// 		secretInformer, client := fixSecretInformer()
// 		svc := k8s.NewSecretService(secretInformer, client)
//
// 		update := exampleSecret.DeepCopy()
// 		update.Labels = map[string]string{
...
// 		secret, err = client.Secrets(exampleNamespace).Get(exampleName, metav1.GetOptions{})
// 		require.NoError(t, err)
// 		assert.Equal(t, exampleSecret, secret)
// 	})
//
...
// 		exampleNamespace := "exampleNamespace"
// 		exampleSecret := fixSecret(exampleName, exampleNamespace, nil)
// 		secretInformer, client := fixFailingSecretInformer(exampleSecret)
// 		svc := k8s.NewSecretService(secretInformer, client)
//
// 		update := exampleSecret.DeepCopy()
// 		update.Labels = map[string]string{
...
// 		exampleName := "exampleSecret"
// 		exampleNamespace := "exampleNamespace"
// 		returnedSecret := fixSecretWithoutTypeMeta(exampleName, exampleNamespace, nil)
// 		expectedSecret := fixSecret(exampleName, exampleNamespace, nil)
// 		secretInformer, client := fixSecretInformer(returnedSecret)
// 		svc := k8s.NewSecretService(secretInformer, client)
//
// 		update := expectedSecret.DeepCopy()
// 		update.Labels = map[string]string{
// 			"example": "example",
// 		}
//
...
//
// 		require.NoError(t, err)
// 		_, err = client.Secrets(exampleNamespace).Get(exampleName, metav1.GetOptions{})

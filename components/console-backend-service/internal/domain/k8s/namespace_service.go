...
func (svc *namespaceService) Create(name string, labels gqlschema.Labels) (*v1.Namespace, error) {
	...
	return svc.client.Namespaces().Create(context.TODO(), &namespace, metav1.CreateOptions{})
}
...
func (svc *namespaceService) Update(name string, labels gqlschema.Labels) (*v1.Namespace, error) {
	...
	err := retry.RetryOnConflict(retry.DefaultBackoff, func() error {
		...
		updated, err = svc.client.Namespaces().Update(context.TODO(), namespace, metav1.UpdateOptions{})
...
func (svc *namespaceService) Delete(name string) error {
	return svc.client.Namespaces().Delete(context.TODO(), name, metav1.DeleteOptions{})
}

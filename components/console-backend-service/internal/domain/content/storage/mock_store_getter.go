...
func (_m *mockStoreGetter) ODataSpec(id string) (*ODataSpec, bool, error) {
	ret := _m.Called(id)

	var r0 *ODataSpec
	if rf, ok := ret.Get(0).(func(string) *ODataSpec); ok {
		r0 = rf(id)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*ODataSpec)
		}
	}
...
func (_m *mockStoreGetter) OpenApiSpec(id string) (*OpenApiSpec, bool, error) {
	ret := _m.Called(id)

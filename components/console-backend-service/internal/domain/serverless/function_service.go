...
func (svc *functionService) Create(function *v1alpha1.Function) (*v1alpha1.Function, error) {
	...
	created, err := svc.Client.Namespace(function.ObjectMeta.Namespace).Create(context.TODO(), u, metav1.CreateOptions{})
	if err != nil {
		return nil, err
	}
...
func (svc *functionService) Update(function *v1alpha1.Function) (*v1alpha1.Function, error) {
	...
	updated, err := svc.Client.Namespace(function.ObjectMeta.Namespace).Update(context.TODO(), u, metav1.UpdateOptions{})
	if err != nil {
		return nil, err
	}
...
func (svc *functionService) Delete(function gqlschema.FunctionMetadataInput) error {
	return svc.Client.Namespace(function.Namespace).Delete(context.TODO(), function.Name, metav1.DeleteOptions{})
}

...
func (_m *Resolver) APIRuleQuery(ctx context.Context, name string, namespace string) (*v1alpha1.APIRule, error) {
...
func (_m *Resolver) APIRulesQuery(ctx context.Context, namespace string, serviceName *string, hostname *string) ([]*v1alpha1.APIRule, error) {
	var r0 []*v1alpha1.APIRule
	var r1 error
	r1 = _m.err
...
func (_m *Resolver) CreateAPIRule(ctx context.Context, name string, namespace string, params gqlschema.APIRuleInput) (*v1alpha1.APIRule, error) {
	var r0 *v1alpha1.APIRule
	var r1 error
	r1 = _m.err
...
func (_m *Resolver) DeleteAPIRule(ctx context.Context, name string, namespace string) (*v1alpha1.APIRule, error) {
	var r0 *v1alpha1.APIRule
	var r1 error
	r1 = _m.err
...
func (_m *Resolver) UpdateAPIRule(ctx context.Context, name string, namespace string, params gqlschema.APIRuleInput) (*v1alpha1.APIRule, error) {
	var r0 *v1alpha1.APIRule
	var r1 error
	r1 = _m.err

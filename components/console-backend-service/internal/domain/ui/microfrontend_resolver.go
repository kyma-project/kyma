...
type microfrontendLister interface {
	List() ([]*v1alpha1.MicroFrontend, error)
}
...
func (r *microfrontendResolver) MicrofrontendsQuery(ctx context.Context) ([]gqlschema.Microfrontend, error) {
	var items []*v1alpha1.MicroFrontend
	var err error

	items, err = r.microfrontendLister.List()

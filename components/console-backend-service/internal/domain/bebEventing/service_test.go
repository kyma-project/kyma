...
//
//		serviceFactory, err := NewFakeGenericServiceFactory(v1alpha1.AddToScheme, subscription1, subscription2)
//		require.NoError(t, err)
//
//		service := New(serviceFactory, nil)
//		err = service.Enable()
//		require.NoError(t, err)
//
...
//		subscription1 := fixTestSubscription("test-sub-1", "default", "owner-1")
//
//		serviceFactory, err := NewFakeGenericServiceFactory(v1alpha1.AddToScheme, subscription1)
//		require.NoError(t, err)
//
//		service := New(serviceFactory, nil)
//		err = service.Enable()
...
//		serviceFactory, err := NewFakeGenericServiceFactory(v1alpha1.AddToScheme)
//		require.NoError(t, err)
//
//		service := New(serviceFactory, nil)
//		err = service.Enable()
...
//func NewFakeGenericServiceFactory(addToScheme func(*runtime.Scheme) error, objects ...*v1alpha1.Subscription) (*resource.GenericServiceFactory, error) {
...
//
//	// add passed objects
//	result := make([]runtime.Object, len(objects)+1)
...
//
//	// add secret
//	result[len(objects)], err = resource.ToUnstructured(secret)
//	if err != nil {
//		return nil, err
//	}
//

...
func (svc *serviceInstanceService) Create(params serviceInstanceCreateParameters) (*v1beta1.ServiceInstance, error) {
	...
	return svc.client.ServicecatalogV1beta1().ServiceInstances(params.Namespace).Create(context.TODO(), &instance, v1.CreateOptions{})
}

func (svc *serviceInstanceService) Delete(name, namespace string) error {
	return svc.client.ServicecatalogV1beta1().ServiceInstances(namespace).Delete(context.TODO(), name, v1.DeleteOptions{})
}

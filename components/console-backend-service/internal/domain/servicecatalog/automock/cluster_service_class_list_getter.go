...
// clusterServiceClassListGetter is an autogenerated mock type for the clusterServiceClassListGetter type
type clusterServiceClassListGetter struct {
	mock.Mock
}

// Find provides a mock function with given fields: name
func (_m *clusterServiceClassListGetter) Find(name string) (*v1beta1.ClusterServiceClass, error) {
	ret := _m.Called(name)
...
func (_m *clusterServiceClassListGetter) FindByExternalName(externalName string) (*v1beta1.ClusterServiceClass, error) {
...
func (_m *clusterServiceClassListGetter) List(pagingParams pager.PagingParams) ([]*v1beta1.ClusterServiceClass, error) {

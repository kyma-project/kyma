...
// mockGqlInstanceConverter is an autogenerated mock type for the gqlServiceInstanceConverter type
...
func (_m *mockGqlInstanceConverter) GQLCreateInputToInstanceCreateParameters(in *gqlschema.ServiceInstanceCreateInput) *serviceInstanceCreateParameters {
	ret := _m.Called(in)

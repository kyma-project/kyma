...
func TestFromUnstructured(t *testing.T) {
	t.Run("Success", func(t *testing.T) {
		...
		err := resource_v2.FromUnstructured(obj, result)
	...
	t.Run("Nil", func(t *testing.T) {
		...
		err := resource_v2.FromUnstructured(nil, result)
		require.NoError(t, err)
		assert.Nil(t, result)
	})
}
...
func TestToUnstructured(t *testing.T) {
	t.Run("Success", func(t *testing.T) {
		...
		result, err := resource_v2.ToUnstructured(obj)
		require.NoError(t, err)
		assert.Equal(t, expected, result)
	})

	t.Run("Nil", func(t *testing.T) {
		result, err := resource_v2.ToUnstructured(nil)
		require.NoError(t, err)
		assert.Nil(t, result)
	})
}

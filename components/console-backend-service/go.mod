...
require (
	...
	github.com/kyma-project/kyma v0.5.1-0.20200609083752-772ad7b2d2a0
	github.com/kyma-project/kyma/components/application-operator v0.0.0-20200721111628-4ef005580766

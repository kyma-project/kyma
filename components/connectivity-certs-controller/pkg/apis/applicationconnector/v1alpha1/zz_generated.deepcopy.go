...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CentralConnectionError) DeepCopyInto(out *CentralConnectionError) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CentralConnectionError.
func (in *CentralConnectionError) DeepCopy() *CentralConnectionError {
	if in == nil {
		return nil
	}
	out := new(CentralConnectionError)
	in.DeepCopyInto(out)
	return out
}
...
func (in *CentralConnectionStatus) DeepCopyInto(out *CentralConnectionStatus) {
	*out = *in
	in.SynchronizationStatus.DeepCopyInto(&out.SynchronizationStatus)

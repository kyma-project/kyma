...
// MutualTLSClient is an autogenerated mock type for the MutualTLSClient type
type MutualTLSClient struct {
	mock.Mock
}

// GetManagementInfo provides a mock function with given fields: managementInfoURL
func (_m *MutualTLSClient) GetManagementInfo(managementInfoURL string) (connectorservice.ManagementInfo, error) {
...
func (_m *MutualTLSClient) RenewCertificate(renewalURL string) (certificates.Certificates, error) {

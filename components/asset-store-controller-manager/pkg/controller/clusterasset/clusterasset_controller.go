...
const deleteClusterAssetFinalizerName = "deleteclusterasset.finalizers.asset-store.kyma-project.io"
...
// +kubebuilder:rbac:groups=asset-store.kyma-project.io,resources=clusterassets,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=asset-store.kyma-project.io,resources=clusterassets/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=asset-store.kyma-project.io,resources=clusterbuckets,verbs=get;list;watch
// +kubebuilder:rbac:groups=asset-store.kyma-project.io,resources=clusterbuckets/status,verbs=get;list

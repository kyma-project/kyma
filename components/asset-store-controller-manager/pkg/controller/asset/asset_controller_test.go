...
func TestReconcileAsset_Reconcile(t *testing.T) {
	//Given
	name := "test-asset"
	newFilter := "abcd"
	...
	validateAsset(cfg, asset, v1alpha2.AssetPending, pretty.Scheduled, "", nil)
	...
	validateAsset(cfg, asset, v1alpha2.AssetReady, pretty.Uploaded, testData.assetUrl, testData.files)
...
func validateAsset(cfg *testSuite, instance *v1alpha2.Asset, phase v1alpha2.AssetPhase, reason pretty.Reason, baseUrl string, files []string) {
	g := cfg.g

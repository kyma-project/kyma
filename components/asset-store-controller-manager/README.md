...
| **APP_WEBHOOK_MUTATION_WORKERS_COUNT** | No | `10` | The number of workers that will be used to mutate files in parallel |
...
| **APP_WEBHOOK_VALIDATION_WORKERS_COUNT** | No | `10` | The number of workers that will be used to validate files in parallel |
...
| **APP_STORE_UPLOAD_WORKERS_COUNT** | No | `10` | The number of workers that will be used to upload files to storage bucket in parallel |

...
import (
	...
	k8smocks "github.com/kyma-project/kyma/components/gateway/internal/k8sconsts/mocks"
	"github.com/kyma-project/kyma/components/gateway/internal/metadata"
	metadataMock "github.com/kyma-project/kyma/components/gateway/internal/metadata/mocks"
	"github.com/kyma-project/kyma/components/gateway/internal/metadata/serviceapi"
	"github.com/kyma-project/kyma/components/gateway/internal/proxy/mocks"
	"github.com/kyma-project/kyma/components/gateway/internal/proxy/proxycache"
	cacheMock "github.com/kyma-project/kyma/components/gateway/internal/proxy/proxycache/mocks"
...
func TestProxy(t *testing.T) {
	...
	t.Run("should proxy on cache miss", func(t *testing.T) {
		...
		httpCacheMock.On("Add", "uuid-1", "", "", "", mock.AnythingOfType("*httputil.ReverseProxy"), ts.URL).Return(
			&proxycache.Proxy{
				Proxy:        httputil.NewSingleHostReverseProxy(u),
				ClientId:     "",
				OauthUrl:     "",
	...
	t.Run("should invalidate proxy and retry when 403 occurred", func(t *testing.T) {
		...
		httpCacheMock := &cacheMock.HTTPProxyCache{}
		httpCacheMock.On("Get", "uuid-1").Return(nil, false)
		httpCacheMock.On("Add", "uuid-1", "", "", "", mock.AnythingOfType("*httputil.ReverseProxy"), tsf.URL).Return(
			&proxycache.Proxy{
				Proxy:        httputil.NewSingleHostReverseProxy(u),
				ClientId:     "",
				OauthUrl:     "",

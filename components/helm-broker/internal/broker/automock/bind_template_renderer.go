...
func (_m *BindTemplateRenderer) Render(bindTemplate internal.BundlePlanBindTemplate, resp *helm.ReleaseResponse) (bind.RenderedBindYAML, error) {
	ret := _m.Called(bindTemplate, resp)

	var r0 bind.RenderedBindYAML
	if rf, ok := ret.Get(0).(func(internal.BundlePlanBindTemplate, *helm.ReleaseResponse) bind.RenderedBindYAML); ok {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(internal.BundlePlanBindTemplate, *helm.ReleaseResponse) error); ok {

...
For the details about Helm Broker configuration, see [this](https://github.com/kyma-project/kyma/blob/master/docs/service-brokers/docs/020-configuration-helm-broker.md) document. See [How to create a bundle](https://github.com/kyma-project/kyma/blob/master/docs/service-brokers/docs/021-configuration-helm-broker-bundles.md) and [Binding bundles](https://github.com/kyma-project/kyma/blob/master/docs/service-brokers/docs/022-configuration-helm-broker-bundles-binding.md) to learn more about the bundles.

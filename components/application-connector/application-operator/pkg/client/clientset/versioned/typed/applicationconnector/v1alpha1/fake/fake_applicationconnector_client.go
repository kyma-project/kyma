...
import (
	v1alpha1 "github.com/kyma-project/kyma/components/application-connector/application-operator/pkg/client/clientset/versioned/typed/applicationconnector/v1alpha1"

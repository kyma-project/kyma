...
import (
	...
	csrfClient "github.com/kyma-project/kyma/components/application-connector/central-application-gateway/internal/csrf/client"
	csrfStrategy "github.com/kyma-project/kyma/components/application-connector/central-application-gateway/internal/csrf/strategy"
	"github.com/kyma-project/kyma/components/application-connector/central-application-gateway/internal/externalapi"
	...
	"github.com/kyma-project/kyma/components/application-connector/central-application-gateway/internal/metadata/secrets"
	"github.com/kyma-project/kyma/components/application-connector/central-application-gateway/internal/metadata/serviceapi"
	"github.com/kyma-project/kyma/components/application-connector/central-application-gateway/internal/proxy"

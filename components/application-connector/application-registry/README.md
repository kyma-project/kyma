...
This is the repository for the Application Registry, which is a part of the Application Connector. See [this](../../../docs/01-overview/main-areas/application-connectivity) directory for more documentation for this component.

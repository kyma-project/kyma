...
import (
	...
	clientcontextmiddlewares "github.com/kyma-project/kyma/components/application-connector/connector-service/internal/clientcontext/middlewares"
	"github.com/kyma-project/kyma/components/application-connector/connector-service/internal/errorhandler"
	"github.com/kyma-project/kyma/components/application-connector/connector-service/internal/externalapi"
	"github.com/kyma-project/kyma/components/application-connector/connector-service/internal/externalapi/middlewares"
	"github.com/kyma-project/kyma/components/application-connector/connector-service/internal/internalapi"
	"github.com/kyma-project/kyma/components/application-connector/connector-service/internal/revocation"
	certificateMiddlewares "github.com/kyma-project/kyma/components/application-connector/connector-service/internal/revocation/middlewares"
	"github.com/kyma-project/kyma/components/application-connector/connector-service/internal/secrets"

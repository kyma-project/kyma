...
public class CloudEventImpl implements TraceableRequest, CloudEvent {
    ...
    public CloudEventImpl(ContainerRequestContext req, OpenTelemetry openTelemetry, Tracer tracer, URI publisherAddr) {
        this.req = req;

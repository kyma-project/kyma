...
### Contract between the Application Gateway and the UI API Facade

The UI API Facade must check the status of the Application Gateway instance that represents the Remote Environment.

...
import "github.com/kyma-project/kyma/components/metadata-service/internal/metadata/applications"
...
func (_m *Service) New(remoteEnvironment string, id string, api *model.API) (*applications.ServiceAPI, apperrors.AppError) {
...
func (_m *Service) Read(remoteEnvironment string, serviceApi *applications.ServiceAPI) (*model.API, apperrors.AppError) {
...
func (_m *Service) Update(remoteEnvironment string, id string, api *model.API) (*applications.ServiceAPI, apperrors.AppError) {
	ret := _m.Called(remoteEnvironment, id, api)

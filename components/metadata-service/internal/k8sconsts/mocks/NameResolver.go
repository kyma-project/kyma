...
// GetMetadataUrl provides a mock function with given fields: remoteEnvironment, id
func (_m *NameResolver) GetMetadataUrl(remoteEnvironment string, id string) string {

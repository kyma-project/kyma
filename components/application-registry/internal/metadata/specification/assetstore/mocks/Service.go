...
func (_m *Service) Put(id string, apiType string, documentation []byte, apiSpec []byte, eventsSpec []byte) apperrors.AppError {
	ret := _m.Called(id, apiType, documentation, apiSpec, eventsSpec)

	var r0 apperrors.AppError
	if rf, ok := ret.Get(0).(func(string, string, []byte, []byte, []byte) apperrors.AppError); ok {

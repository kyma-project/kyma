...
func (_m *RequestParametersService) Create(application string, serviceID string, requestParameters *model.RequestParameters) (string, apperrors.AppError) {
	ret := _m.Called(application, serviceID, requestParameters)

	var r0 string
	if rf, ok := ret.Get(0).(func(string, string, *model.RequestParameters) string); ok {
		r0 = rf(application, serviceID, requestParameters)
	} else {
		r0 = ret.Get(0).(string)
	}

	var r1 apperrors.AppError
	if rf, ok := ret.Get(1).(func(string, string, *model.RequestParameters) apperrors.AppError); ok {
		r1 = rf(application, serviceID, requestParameters)
	} else {
		if ret.Get(1) != nil {

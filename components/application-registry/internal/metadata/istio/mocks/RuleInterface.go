...
func (_m *RuleInterface) Create(_a0 context.Context, _a1 *v1alpha2.Rule, _a2 v1.CreateOptions) (*v1alpha2.Rule, error) {
	ret := _m.Called(_a0, _a1, _a2)

	var r0 *v1alpha2.Rule
	if rf, ok := ret.Get(0).(func(context.Context, *v1alpha2.Rule, v1.CreateOptions) *v1alpha2.Rule); ok {
		r0 = rf(_a0, _a1, _a2)
	} else {
		if ret.Get(0) != nil {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, *v1alpha2.Rule, v1.CreateOptions) error); ok {
		r1 = rf(_a0, _a1, _a2)
	} else {
		r1 = ret.Error(1)
	}
...
func (_m *RuleInterface) Delete(_a0 context.Context, _a1 string, _a2 v1.DeleteOptions) error {
	ret := _m.Called(_a0, _a1, _a2)

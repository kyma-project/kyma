...
replace (
	...
	github.com/kyma-project/kyma/components/application-gateway => github.com/Szymongib/kyma/components/application-gateway v0.0.0-20200902080656-573e032dd983

...
type PodPresetInterface interface {
	...
	UpdateStatus(*v1alpha1.PodPreset) (*v1alpha1.PodPreset, error)
...
func (c *podPresets) UpdateStatus(podPreset *v1alpha1.PodPreset) (result *v1alpha1.PodPreset, err error) {
	result = &v1alpha1.PodPreset{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("podpresets").

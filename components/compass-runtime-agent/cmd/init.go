...
func createKymaService(k8sResourceClients *k8sResourceClientSets, uploadServiceUrl string, integrationNamespace string, appTLSSkipVerify bool) (kyma.Service, error) {
	...
	converter := applications.NewConverter(nameResolver, appTLSSkipVerify)

...
// ReconcileLabels provides a mock function with given fields: urlsCfg
func (_m *DirectorClient) ReconcileLabels(urlsCfg director.RuntimeURLsConfig) (graphql.Labels, error) {

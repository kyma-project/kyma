...
func (_m *ClientsProvider) GetConnectorCertSecuredClient() (connector.Client, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func() (connector.Client, error)); ok {
		return rf()
	}
...
func (_m *ClientsProvider) GetConnectorTokensClient(url string) (connector.Client, error) {
	...
	var r0 connector.Client
	var r1 error
	if rf, ok := ret.Get(0).(func(string) (connector.Client, error)); ok {
		return rf(url)
	}
...
func (_m *ClientsProvider) GetDirectorClient(runtimeConfig config.RuntimeConfig) (director.DirectorClient, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(config.RuntimeConfig) (director.DirectorClient, error)); ok {
		return rf(runtimeConfig)
	}
...
// NewClientsProvider creates a new instance of ClientsProvider. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewClientsProvider(t interface {
	mock.TestingT
	Cleanup(func())
}) *ClientsProvider {
	mock := &ClientsProvider{}
	mock.Mock.Test(t)

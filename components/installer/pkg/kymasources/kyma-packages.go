...
// HasInjectedSources returns true when there are kyma sources that were injected into installer
...
// GetInjectedPackage returns `KymaPackage` injected into installer or error when it does not exist

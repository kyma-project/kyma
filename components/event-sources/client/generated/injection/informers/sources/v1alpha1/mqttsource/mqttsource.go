...
func Get(ctx context.Context) v1alpha1.MQTTSourceInformer {
	untyped := ctx.Value(Key{})
	if untyped == nil {
		logging.FromContext(ctx).Panic(
			"Unable to fetch github.com/kyma-project/kyma/components/event-sources/client/generated/informer/externalversions/sources/v1alpha1.MQTTSourceInformer from context.")
	}

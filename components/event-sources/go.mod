...
require (
	...
	github.com/kyma-project/kyma/components/event-publisher-proxy v0.0.0-20201014135541-82b304ab245a // indirect
	...
	github.com/nats-io/nats.go v1.10.1-0.20201204000952-090c71e95cd0 // indirect

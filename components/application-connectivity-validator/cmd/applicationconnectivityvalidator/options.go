...
func parseOptions() (*options, error) {
	...
	mainURL := flag.String("mainURL", "", "The address of the Kubernetes API server. Overrides any value in kubeconfig. Only required if out-of-cluster.")
...
func (o *options) String() string {
	return fmt.Sprintf("--proxyPort=%d --externalAPIPort=%d --tenant=%s --group=%s "+
		...
		"--kubeConfig=%s --mainURL=%s --syncPeriod=%d "+
		...
		o.kubeConfig, o.mainURL, o.syncPeriod,

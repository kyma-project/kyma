...
func main() {
	...
	helmClient, err := kymahelm.NewClient(*helmHost, *tlsKey, *tlsCrt, *TLSInsecureSkipVerify, overridesLogger, *helmMaxHistory, *helmTimeout)
	if err != nil {
	...
	installationFinalizerManager := finalizer.NewManager(env.Config.InstFinalizer)

...
func TestApiRuleConverter_ToApiRule(t *testing.T) {
	...
	t.Run("Success", func(t *testing.T) {
		...
		result,err := converter.ToApiRule(name, namespace, apiRuleInput)
		require.NoError(t, err)
...
func fixApiRuleInput(hostname string, serviceName string, servicePort int, gateway string) model.APIRuleInput {

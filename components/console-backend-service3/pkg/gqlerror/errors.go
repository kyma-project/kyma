...
import (
	...
	apierrors "github.com/kyma-project/kyma/components/console-backend-service3/pkg/apierror"
...
func New(err error, kind fmt.Stringer, opts ...Option) error {
	...
	case k8serrors.IsNotFound(err):
		return NewNotFoundFromError(err.Error(), kind, opts...)
...
func NewNotFoundFromError(err string, kind fmt.Stringer, opts ...Option) error {

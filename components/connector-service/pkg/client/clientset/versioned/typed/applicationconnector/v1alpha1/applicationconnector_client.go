...
import (
	...
	"github.com/kyma-project/kyma/components/connector-service/pkg/client/clientset/versioned/scheme"
...
func (c *ApplicationconnectorV1alpha1Client) KymaGroups() KymaGroupInterface {
	return newKymaGroups(c)
}

...
func (h *FunctionCreateHandler) mutatingFunctionFn(obj *runtimev1alpha1.Function, rnInfo *runtimeUtil.RuntimeInfo) {
	log.Info("Mutate")
	if obj.Spec.Size == "" {
...
func (h *FunctionCreateHandler) validateFunctionFn(obj *runtimev1alpha1.Function, rnInfo *runtimeUtil.RuntimeInfo) error {

...
func (_m *ApplicationManagerClient) Get(ctx context.Context, key types.NamespacedName, obj client.Object) error {
...
func (_m *ApplicationManagerClient) Update(ctx context.Context, obj client.Object, opts ...client.UpdateOption) error {

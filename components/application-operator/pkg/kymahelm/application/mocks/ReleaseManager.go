...
// UpgradeChart provides a mock function with given fields: _a0
func (_m *ReleaseManager) UpgradeChart(_a0 *v1alpha1.Application) (release.Status_Code, string, error) {
	ret := _m.Called(_a0)

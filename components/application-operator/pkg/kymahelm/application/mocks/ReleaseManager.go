...
// DeleteChart provides a mock function with given fields: name
func (_m *ReleaseManager) DeleteChart(name string) error {
	ret := _m.Called(name)
...
// InstallChart provides a mock function with given fields: name
func (_m *ReleaseManager) InstallChart(name string) (release.Status_Code, string, error) {
	ret := _m.Called(name)

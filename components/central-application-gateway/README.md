...
- `400 Bad Request` - returned when an Application, service, or entry for the [Compass mode](https://kyma-project.io/docs/kyma/latest/01-overview/application-connectivity/) is not specified in the path.

...
func NewCommander(enableDebugLogs bool, metricsAddr, probeAddr, readyEndpoint, healthEndpoint string, maxReconnects int, reconnectWait time.Duration) *Commander {
	return &Commander{

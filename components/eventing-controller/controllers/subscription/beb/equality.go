...
import (
	...
	eventing1alpha1 "github.com/kyma-project/kyma/components/eventing-controller/api/v1alpha1"
)

// conditionsEquals checks if two list of conditions are equal.
func conditionsEquals(existing, expected []eventing1alpha1.Condition) bool {
	...
	existingMap := make(map[eventing1alpha1.ConditionType]eventing1alpha1.Condition, len(existing))
...
func conditionEquals(existing, expected eventing1alpha1.Condition) bool {
...
func isSubscriptionStatusEqual(oldStatus, newStatus eventing1alpha1.SubscriptionStatus) bool {
	...
	oldStatusWithoutCond.Conditions = []eventing1alpha1.Condition{}
	newStatusWithoutCond.Conditions = []eventing1alpha1.Condition{}

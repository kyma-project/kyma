...
func (r *Reconciler) handlePreviousAPIRule(ctx context.Context, subscription *eventingv1alpha2.Subscription,
	...
	if len(ownerReferences) < len(previousAPIRule.OwnerReferences) {
		...
		objectv2.WithOwnerReference(subscriptions)(previousAPIRule)
		objectv2.WithRules(subscriptions, *previousAPIRule.Spec.Service, http.MethodPost, http.MethodOptions)(previousAPIRule)

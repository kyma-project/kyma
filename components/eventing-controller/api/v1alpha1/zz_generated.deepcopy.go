...
func (in *EventMeshFilter) DeepCopy() *EventMeshFilter {
	...
	out := new(EventMeshFilter)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *EventMeshFilters) DeepCopyInto(out *EventMeshFilters) {
	*out = *in
	if in.Filters != nil {
		in, out := &in.Filters, &out.Filters
		*out = make([]*EventMeshFilter, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(EventMeshFilter)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new EventMeshFilters.
func (in *EventMeshFilters) DeepCopy() *EventMeshFilters {
	if in == nil {
		return nil
	}
	out := new(EventMeshFilters)
	in.DeepCopyInto(out)
	return out
}

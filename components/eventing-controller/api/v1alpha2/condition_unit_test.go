...
func Test_InitializeSubscriptionConditions(t *testing.T) {
	var tests = []struct {
		name            string
		givenConditions []eventingv1alpha2.Condition
	}{
		{
			name: "Conditions empty",
			givenConditions: func() []eventingv1alpha2.Condition {
				return eventingv1alpha2.MakeSubscriptionConditions()
			}(),
		},
		{
			...
			givenConditions: func() []eventingv1alpha2.Condition {
				...
				return []eventingv1alpha2.Condition{
					{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			// given
			g := NewGomegaWithT(t)
			s := eventingv1alpha2.SubscriptionStatus{}
			s.Conditions = tt.givenConditions
			wantConditionTypes := []eventingv1alpha2.ConditionType{eventingv1alpha2.ConditionSubscribed, eventingv1alpha2.ConditionSubscriptionActive, eventingv1alpha2.ConditionAPIRuleStatus, eventingv1alpha2.ConditionWebhookCallStatus}
			...
			foundConditionTypes := make([]eventingv1alpha2.ConditionType, 0)
...
func Test_IsReady(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			...
			givenConditions: []eventingv1alpha2.Condition{{Type: eventingv1alpha2.ConditionSubscribed, Status: corev1.ConditionTrue}},
			wantReadyStatus: false,
		},
		{
			name:            "should not be ready if only ConditionSubscriptionActive is available and true",
			givenConditions: []eventingv1alpha2.Condition{{Type: eventingv1alpha2.ConditionSubscriptionActive, Status: corev1.ConditionTrue}},
			wantReadyStatus: false,
		},
		{
			name:            "should not be ready if only ConditionAPIRuleStatus is available and true",
			givenConditions: []eventingv1alpha2.Condition{{Type: eventingv1alpha2.ConditionAPIRuleStatus, Status: corev1.ConditionTrue}},
			wantReadyStatus: false,
		},
		{
			...
			givenConditions: []eventingv1alpha2.Condition{
				...
				{Type: eventingv1alpha2.ConditionSubscriptionActive, Status: corev1.ConditionUnknown},
		...
		},
		{
			...
			givenConditions: []eventingv1alpha2.Condition{
				...
				{Type: eventingv1alpha2.ConditionAPIRuleStatus, Status: corev1.ConditionFalse},
			},
			wantReadyStatus: false,
		},
		{
			...
			givenConditions: []eventingv1alpha2.Condition{
				...
				{Type: eventingv1alpha2.ConditionSubscriptionActive, Status: corev1.ConditionTrue},
				{Type: eventingv1alpha2.ConditionAPIRuleStatus, Status: corev1.ConditionTrue},
				{Type: eventingv1alpha2.ConditionWebhookCallStatus, Status: corev1.ConditionTrue},
			},
...
func Test_FindCondition(t *testing.T) {
	...
	testCases := []struct {
		name              string
		givenConditions   []eventingv1alpha2.Condition
		findConditionType eventingv1alpha2.ConditionType
		wantCondition     *eventingv1alpha2.Condition
	}{
		{
			name: "should be able to find the present condition",
			givenConditions: []eventingv1alpha2.Condition{
				{Type: eventingv1alpha2.ConditionSubscribed, Status: corev1.ConditionTrue, LastTransitionTime: currentTime},
				{Type: eventingv1alpha2.ConditionSubscriptionActive, Status: corev1.ConditionTrue, LastTransitionTime: currentTime},
				{Type: eventingv1alpha2.ConditionAPIRuleStatus, Status: corev1.ConditionTrue, LastTransitionTime: currentTime},
				{Type: eventingv1alpha2.ConditionWebhookCallStatus, Status: corev1.ConditionTrue, LastTransitionTime: currentTime},
			},
			findConditionType: eventingv1alpha2.ConditionSubscriptionActive,
			wantCondition:     &eventingv1alpha2.Condition{Type: eventingv1alpha2.ConditionSubscriptionActive, Status: corev1.ConditionTrue, LastTransitionTime: currentTime},
		},
		{
...
func Test_conditionsEquals(t *testing.T) {
	testCases := []struct {
		name            string
		conditionsSet1  []eventingv1alpha2.Condition
		conditionsSet2  []eventingv1alpha2.Condition
		...
		},
		{
			...
			conditionsSet2: []eventingv1alpha2.Condition{
				{Type: eventingv1alpha2.ConditionAPIRuleStatus, Status: corev1.ConditionTrue},
				{Type: eventingv1alpha2.ConditionControllerReady, Status: corev1.ConditionTrue},
			},
			wantEqualStatus: false,
		},
	}
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			if gotEqualStatus := eventingv1alpha2.ConditionsEquals(tc.conditionsSet1, tc.conditionsSet2); tc.wantEqualStatus != gotEqualStatus {
...
func Test_conditionEquals(t *testing.T) {
	testCases := []struct {
		name            string
		condition1      eventingv1alpha2.Condition
		condition2      eventingv1alpha2.Condition
		wantEqualStatus bool
	}{
		{
		...
		},
		{
			...
			condition1: eventingv1alpha2.Condition{
				Type: eventingv1alpha2.ConditionSubscribed, Status: corev1.ConditionTrue, Message: "",
			},

			condition2: eventingv1alpha2.Condition{
				Type: eventingv1alpha2.ConditionSubscribed, Status: corev1.ConditionTrue, Message: "some message",
			},
			wantEqualStatus: false,
		},
		{
			...
			condition1: eventingv1alpha2.Condition{
				Type: eventingv1alpha2.ConditionSubscribed, Status: corev1.ConditionTrue, Reason: eventingv1alpha2.ConditionReasonSubscriptionDeleted,
			},

			condition2: eventingv1alpha2.Condition{
				Type: eventingv1alpha2.ConditionSubscribed, Status: corev1.ConditionTrue, Reason: eventingv1alpha2.ConditionReasonSubscriptionActive,
			},
			wantEqualStatus: false,
		},
		{
			...
			condition1: eventingv1alpha2.Condition{
				Type:    eventingv1alpha2.ConditionAPIRuleStatus,
				Status:  corev1.ConditionFalse,
				Reason:  eventingv1alpha2.ConditionReasonAPIRuleStatusNotReady,
	...
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			if gotEqualStatus := eventingv1alpha2.ConditionEquals(tc.condition1, tc.condition2); tc.wantEqualStatus != gotEqualStatus {

...
import (
	jetstreamv2 "github.com/kyma-project/kyma/components/eventing-controller/pkg/backend/jetstreamv2"
...
func (_m *Backend) Initialize(connCloseHandler jetstreamv2.ConnClosedHandler) error {
	ret := _m.Called(connCloseHandler)

	var r0 error
	if rf, ok := ret.Get(0).(func(jetstreamv2.ConnClosedHandler) error); ok {

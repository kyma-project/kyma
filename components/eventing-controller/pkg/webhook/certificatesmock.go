...
func (r *MockClientGoCert) generateSelfSignedCertKey(
	host string,
	alternateIPs []net.IP,
	alternateDNS []string) ([]byte, []byte, error) {
...
var (
	...
	ErrFakeNotfound    = apiErrors.NewNotFound(
		schema.GroupResource{Group: "test", Resource: "test"}, "fake resource not found")
)

func (r *MockGetFailedClient) Get(
	ctx context.Context,
...
func (r *MockCreateFailedClient) Get(
	ctx context.Context,
	key client.ObjectKey,
	obj client.Object,
	opts ...client.GetOption) error {
...
func (r *MockCreateFailedClient) Create(
	ctx context.Context,
	obj client.Object,
...
func (r *MockUpdateFailedClient) Get(
	ctx context.Context,
	key client.ObjectKey,
	obj client.Object,
	opts ...client.GetOption) error {

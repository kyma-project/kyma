...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (fn *Function) DeepCopyInto(out *Function) {
	*out = *fn
	out.TypeMeta = fn.TypeMeta
	fn.ObjectMeta.DeepCopyInto(&out.ObjectMeta)
	fn.Spec.DeepCopyInto(&out.Spec)
	fn.Status.DeepCopyInto(&out.Status)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new Function.
func (fn *Function) DeepCopy() *Function {
	if fn == nil {
		return nil
	}
	out := new(Function)
...
func (fn *Function) DeepCopyObject() runtime.Object {
	if c := fn.DeepCopy(); c != nil {
		return c
	}
	return nil
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (spec *FunctionSpec) DeepCopyInto(out *FunctionSpec) {
	*out = *spec
	if spec.Env != nil {
	...
	if spec.MinReplicas != nil {
		in, out := &spec.MinReplicas, &out.MinReplicas
		*out = new(int32)
		**out = **in
	}
	if spec.MaxReplicas != nil {
		in, out := &spec.MaxReplicas, &out.MaxReplicas
		*out = new(int32)
		**out = **in
	}
	if spec.Labels != nil {
...
func (spec *FunctionSpec) DeepCopy() *FunctionSpec {
	if spec == nil {
		return nil
	}

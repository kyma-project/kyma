...
type InlineFunctionSpec struct {
	GenericFunctionSpec `json:",inline"`
	InlineSource        `json:",inline"`
}

type GitFunctionSpec struct {
	GenericFunctionSpec `json:",inline"`
	GitRepositorySource `json:",inline"`
}
...
type Function struct {
	...
	Spec   InlineFunctionSpec `json:"spec,omitempty"`

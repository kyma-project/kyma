...
type FunctionConfig struct {
	ImageCredentialsSecretName     string        `envconfig:"default=serverless-registry-credentials"`
	ImagePullSecretName            string        `envconfig:"default=serverless-image-pull-secret"`

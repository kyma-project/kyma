...
func WithIgnoreOnConflict(backoff wait.Backoff, fn func() error, callbacks ...func(...interface{})) error {
	return retry.OnError(backoff, errorFn(callbacks...), fnWithIgnore(fn, errors.IsConflict, callbacks...))
}

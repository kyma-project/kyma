...
import (
	...
	"github.com/kyma-project/kyma/components/function-controller/migrator/pkg/resource/apis/types/meta"
...
type ApiStatus struct {
	ValidationStatus     meta.StatusCode            `json:"validationStatus,omitempty"`
	AuthenticationStatus meta.GatewayResourceStatus `json:"authenticationStatus,omitempty"`
	VirtualServiceStatus meta.GatewayResourceStatus `json:"virtualServiceStatus,omitempty"`
}
...
func (s *ApiStatus) SetInProgress() {
	s.ValidationStatus = meta.InProgress

...
// EventMeshConfig represents the environment config for the Event Publisher to Event Mesh.
type EventMeshConfig struct {
	...
	// Namespace is the name of the namespace in Event Mesh which is used as the event source for legacy events.

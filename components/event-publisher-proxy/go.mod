...
require (
	...
	github.com/kyma-project/kyma/components/eventing-controller v0.0.0-20231109060503-a4f10dcc39eb
...
require (
	...
	github.com/kyma-project/kyma/common/logging v0.0.0-20231025103331-ecda502ad878 // indirect

...
require (
	...
	github.com/kyma-project/kyma/components/application-operator v0.0.0-20220826051949-4ed4d5883dce
...
require (
	...
	github.com/kyma-project/kyma/common/logging v0.0.0-20220818120541-277787e6c2ec // indirect

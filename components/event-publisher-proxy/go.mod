...
require (
	...
	github.com/kyma-project/kyma/components/application-operator v0.0.0-20220609154355-1465f7118404
	github.com/kyma-project/kyma/components/eventing-controller v0.0.0-20220609154355-1465f7118404

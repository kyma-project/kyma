...
require (
	...
	github.com/kyma-project/kyma/components/application-operator v0.0.0-20220505114327-5bacf9bfadd4
	github.com/kyma-project/kyma/components/eventing-controller v0.0.0-20220505114327-5bacf9bfadd4

...
require (
	...
	github.com/kyma-project/kyma/components/application-operator v0.0.0-20220506151527-6c74f7543a36
	github.com/kyma-project/kyma/components/eventing-controller v0.0.0-20220506151527-6c74f7543a36

...
require (
	...
	github.com/kyma-project/kyma/components/application-operator v0.0.0-20220421104831-69143eb27c90
	github.com/kyma-project/kyma/components/eventing-controller v0.0.0-20220421104831-69143eb27c90

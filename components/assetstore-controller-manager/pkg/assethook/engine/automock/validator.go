...
func (_m *Validator) Validate(ctx context.Context, object engine.Accessor, basePath string, files []string, services []v1alpha1.AssetWebhookService) (engine.ValidationResult, error) {
	ret := _m.Called(ctx, object, basePath, files, services)

	var r0 engine.ValidationResult
	if rf, ok := ret.Get(0).(func(context.Context, engine.Accessor, string, []string, []v1alpha1.AssetWebhookService) engine.ValidationResult); ok {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, engine.Accessor, string, []string, []v1alpha1.AssetWebhookService) error); ok {

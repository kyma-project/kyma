...
func TestNameResolver(t *testing.T) {
	testCases := []struct {
	...
	}{
		{
			...
			accessServiceUrl: "http://re-short_remoteenv-c687e68a-9038-4f38-845b-9c61592e59e6.namespace.svc.cluster.local",
		...
		},
		{
			...
			accessServiceUrl: "http://re-max_remoteenv_aaaaaaaaa-c687e68a-9038-4f38-845b-9c61592e59e6.namespace.svc.cluster.local",
		...
		},
		{
			...
			accessServiceUrl: "http://re-toolong_remoteenv_aaaaa-c687e68a-9038-4f38-845b-9c61592e59e6.namespace.svc.cluster.local",

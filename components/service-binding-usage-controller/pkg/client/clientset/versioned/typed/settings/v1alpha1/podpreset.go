...
type PodPresetInterface interface {
	...
	UpdateStatus(ctx context.Context, podPreset *v1alpha1.PodPreset, opts v1.UpdateOptions) (*v1alpha1.PodPreset, error)
...
func (c *podPresets) UpdateStatus(ctx context.Context, podPreset *v1alpha1.PodPreset, opts v1.UpdateOptions) (result *v1alpha1.PodPreset, err error) {
	result = &v1alpha1.PodPreset{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("podpresets").

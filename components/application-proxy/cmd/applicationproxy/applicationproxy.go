...
import (
	...
	"github.com/kyma-project/kyma/components/application-proxy/internal/authorization"
	"github.com/kyma-project/kyma/components/application-proxy/internal/externalapi"
	"github.com/kyma-project/kyma/components/application-proxy/internal/httptools"
	"github.com/kyma-project/kyma/components/application-proxy/internal/metadata"
	...
	"github.com/kyma-project/kyma/components/application-proxy/internal/metadata/serviceapi"
	"github.com/kyma-project/kyma/components/application-proxy/internal/proxy"
...
func main() {
	...
	log.Info("Starting Application Proxy.")
...
func newInternalHandler(serviceDefinitionService metadata.ServiceDefinitionService, options *options) http.Handler {
	...
	return proxy.NewInvalidStateHandler("Application Proxy is not initialized properly")
}

...
import (
	...
	"github.com/kyma-project/kyma/components/connector-service-token-request/pkg/apis"
	"github.com/kyma-project/kyma/components/connector-service-token-request/pkg/controller/tokenrequest"
...
func main() {
	...
	log.Info("Starting ConnectorServiceTokenRequest Controller.")

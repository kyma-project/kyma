...
// SetupChannel is registered for SIGTERM and Interrupt. A stop channel is returned
// and closed on one of these signals. If the second signal is caught, the program

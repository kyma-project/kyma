...
// NewConfigValidator creates a new instance of ConfigValidator. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewConfigValidator(t testing.TB) *ConfigValidator {

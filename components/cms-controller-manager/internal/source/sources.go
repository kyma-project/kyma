...
// or -1 if not found
func IndexByType(slice []v1alpha1.Source, sourceType v1alpha1.DocsTopicSourceType) int {
...
func FilterByType(sources []v1alpha1.Source, sourceType v1alpha1.DocsTopicSourceType) []v1alpha1.Source {

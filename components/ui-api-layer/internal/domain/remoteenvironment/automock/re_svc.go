...
func (_m *reSvc) Create(name string, description string, labels map[string]interface{}) (*v1alpha1.RemoteEnvironment, error) {
	ret := _m.Called(name, description, labels)

	var r0 *v1alpha1.RemoteEnvironment
	if rf, ok := ret.Get(0).(func(string, string, map[string]interface{}) *v1alpha1.RemoteEnvironment); ok {
...
func (_m *reSvc) Delete(name string) error {
	ret := _m.Called(name)
...
func (_m *reSvc) Update(name string, description string, labels map[string]interface{}) (*v1alpha1.RemoteEnvironment, error) {
	ret := _m.Called(name, description, labels)

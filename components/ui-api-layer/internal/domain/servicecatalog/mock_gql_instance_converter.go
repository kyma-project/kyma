...
func (_m *mockGqlInstanceConverter) ToGQL(in *v1beta1.ServiceInstance) *gqlschema.ServiceInstance {
	ret := _m.Called(in)
...
func (_m *mockGqlInstanceConverter) ToGQLs(in []*v1beta1.ServiceInstance) []gqlschema.ServiceInstance {
	ret := _m.Called(in)

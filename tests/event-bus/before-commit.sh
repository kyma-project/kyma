...
${buildEnv} go build -a -installsuffix cgo -o e2e-subscriber/bin/e2e-subscriber ./e2e-subscriber
${buildEnv} go build -a -installsuffix cgo -o e2e-tester/bin/e2e-tester ./e2e-tester

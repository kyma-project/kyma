...
import { V1RuntimeClass } from '../model/v1RuntimeClass';
import { V1RuntimeClassList } from '../model/v1RuntimeClassList';
import { V1Status } from '../model/v1Status';
import { Authentication, Interceptor } from '../model/models';
import { ApiKeyAuth } from '../model/models';
export declare enum NodeV1ApiApiKeys {
    BearerToken = 0
}
export declare class NodeV1Api {
    ...
    setApiKey(key: NodeV1ApiApiKeys, value: string): void;
     ...
     */
    createRuntimeClass(body: V1RuntimeClass, pretty?: string, dryRun?: string, fieldManager?: string, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     */
    listRuntimeClass(pretty?: string, allowWatchBookmarks?: boolean, _continue?: string, fieldSelector?: string, labelSelector?: string, limit?: number, resourceVersion?: string, resourceVersionMatch?: string, timeoutSeconds?: number, watch?: boolean, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
        response: http.IncomingMessage;
        body: V1RuntimeClassList;
    }>;
    /**
     ...
     * @param pretty If \&#39;true\&#39;, then the output is pretty printed.
     */
    readRuntimeClass(name: string, pretty?: string, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     * @param fieldManager fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint.
     */
    replaceRuntimeClass(name: string, body: V1RuntimeClass, pretty?: string, dryRun?: string, fieldManager?: string, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{

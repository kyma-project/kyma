...
import { V1CustomResourceDefinition } from '../model/v1CustomResourceDefinition';
import { V1CustomResourceDefinitionList } from '../model/v1CustomResourceDefinitionList';
import { V1DeleteOptions } from '../model/v1DeleteOptions';
import { V1Status } from '../model/v1Status';
import { Authentication, Interceptor } from '../model/models';
import { ApiKeyAuth } from '../model/models';
export declare enum ApiextensionsV1ApiApiKeys {
    BearerToken = 0
}
export declare class ApiextensionsV1Api {
    ...
    setApiKey(key: ApiextensionsV1ApiApiKeys, value: string): void;
     ...
     */
    createCustomResourceDefinition(body: V1CustomResourceDefinition, pretty?: string, dryRun?: string, fieldManager?: string, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     */
    listCustomResourceDefinition(pretty?: string, allowWatchBookmarks?: boolean, _continue?: string, fieldSelector?: string, labelSelector?: string, limit?: number, resourceVersion?: string, resourceVersionMatch?: string, timeoutSeconds?: number, watch?: boolean, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     * @param pretty If \&#39;true\&#39;, then the output is pretty printed.
     */
    readCustomResourceDefinition(name: string, pretty?: string, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     * @param fieldManager fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint.
     */
    replaceCustomResourceDefinition(name: string, body: V1CustomResourceDefinition, pretty?: string, dryRun?: string, fieldManager?: string, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     * @param fieldManager fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint.
     */
    replaceCustomResourceDefinitionStatus(name: string, body: V1CustomResourceDefinition, pretty?: string, dryRun?: string, fieldManager?: string, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{

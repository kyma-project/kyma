...
func TestCertificateValidation(t *testing.T) {
	...
	err = k8sResourcesClient.DeleteRemoteEnvironment(remoteEnvName, &v1.DeleteOptions{})
	require.NoError(t, err)
	err = k8sResourcesClient.DeleteRemoteEnvironment(forbiddenRemoteEnvName, &v1.DeleteOptions{})
	require.NoError(t, err)
}

...
func NewFunction2(name, namespace string, dynamicCli dynamic.Interface, log shared.Logger) *Function {
	return &Function{
		resCli:      resource.New(dynamicCli, serverlessv1alpha1.GroupVersion.WithResource("functions"), namespace, log, true),
		name:        name,
		namespace:   namespace,

...
replace (
	...
	github.com/kyma-project/kyma/components/function-controller => github.com/kwiatekus/kyma/components/function-controller v0.0.0-20230224144226-1fa97267bca2

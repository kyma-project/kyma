...
func buildWaitForStatusesRunning(iRsc dynamic.ResourceInterface, timeout time.Duration, rscNames ...string) func(string, ...func(...interface{})) error {
	return func(initialResourceVersion string, callbacks ...func(...interface{})) error {
		...
		for _, rsName := range rscNames {
			conditions = append(conditions, isPhaseRunning(rsName, callbacks...))
		}

...
type Config struct {
	...
	GithubAuthPrivateKey            string           `envconfig:"GH_AUTH_PRIVATE_KEY"`
	AzureDevOpsUsername             string           `envconfig:"AZURE_DEVOPS_AUTH_USERNAME"`
	AzureDevOpsPassword             string           `envconfig:"AZURE_DEVOPS_AUTH_PASSWORD"`
}

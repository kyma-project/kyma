...
| **APP_TEST_ADDON_NAME**                 | No       | `test-apirule`              | The name of the AddonsConfiguration created and deleted during integration tests                                                                                 |
...
| **APP_TEST_USAGE_KIND_NAME**            | No       | `knative-service`           | The name of the UsageKind used during integration tests                                                                                 |

...
import (
	...
	"github.com/kyma-project/kyma/tests/application-gateway-tests/test/gateway/testkit/legacy/registry"
)

func TestLegacyProxyService(t *testing.T) {

	testSuit := gateway.NewLegacyTestSuite(t)

...
type TestConfig struct {
	Application string `envconfig:"default=''"`
...
func (c TestConfig) String() string {
	return fmt.Sprintf("Application=%s, Namespace=%s, MockSelectorKey=%s, MockSelectorValue=%s, MockServerPort=%d",
		c.Application, c.Namespace, c.MockSelectorKey, c.MockSelectorValue, c.MockServerPort)
}

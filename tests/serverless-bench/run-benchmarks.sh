...
ALL_FUNCTIONS="nodejs16-xs nodejs16-s nodejs16-m nodejs16-l nodejs16-xl nodejs18-xs nodejs18-s nodejs18-m nodejs18-l nodejs18-xl python39-s python39-m python39-l python39-xl"

...
func (_m *Client) GetConnectionToken(runtimeID string) (graphql.OneTimeTokenForRuntimeExt, error) {
	ret := _m.Called(runtimeID)

	var r0 graphql.OneTimeTokenForRuntimeExt
	if rf, ok := ret.Get(0).(func(string) graphql.OneTimeTokenForRuntimeExt); ok {
		r0 = rf(runtimeID)
	} else {

...
type TwoPhasesEventMeshTestConfig struct {
	domain            string
	testID            string
	skipSSLVerify     bool
...
func (s *TwoPhasesEventMeshTestConfig) AddFlags(set *pflag.FlagSet) {
...
func (s *TwoPhasesEventMeshTestConfig) NewState() *e2EEventMeshState {

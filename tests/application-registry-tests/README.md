...
After building and pushing the Docker image, set the proper tag in the `resources/core/charts/application-connector/charts/application-registry/values.yaml` file, in the`tests.image.tag` property.

...
**clusterName** |-| Name of the Cluster on which the Stability Checker Pod is launched. Cluster name is attached to the tests summary report and sent to the given Slack channel.
